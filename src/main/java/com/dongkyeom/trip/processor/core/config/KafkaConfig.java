package com.dongkyeom.trip.processor.core.config;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic rawGpsTopic() {
        return TopicBuilder.name("raw-gps")
                .partitions(3)
                .replicas(3)
                .build();
    }
    ...
    @Bean
    public NewTopic createRouteTriggerTopic() {
        return TopicBuilder.name("create-route-trigger")
                .partitions(3)
                .replicas(3)
                .build();
    }
